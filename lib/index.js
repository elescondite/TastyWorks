...
const _watchlists = require('./watchlists');
const _publicWatchlists = require('./publicWatchlists');
const _margin = require('./margin');
const _tradingStatus = require('./tradingStatus');
const _futures = require('./futures');
const _decimals = require('./decimals');
const _cryptos = require('./cryptos');
...
module.exports = {
    ...
    watchlists: () => _watchlists(_headers),
    publicWatchlists: () => _publicWatchlists(_headers),
    margin: (account_id) => _margin(_headers, account_id),
    tradingStatus: (account_id) => _tradingStatus(_headers, account_id),
    futures: () => _futures(_headers),
    decimals: () => _decimals(_headers),
    cryptos: () => _cryptos(_headers),
